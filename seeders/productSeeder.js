...
module.exports = async () => {
  const products = [
    ...
    },
    {
      ...
      description:
        "Experience the thrill of cruising with the Cruiser Globe Blazer Blue. This stylish cruiser board features a sleek design and high-performance components for a smooth ride. Whether you're navigating through the city streets or exploring the boardwalk, this cruiser will keep you riding in style.",
      slug: "CRUISER-GLOBE-BLAZER-BLUE",
      highlight: false,
      stock: 15,
      price: 299.99,
      photos: [{ url: "CRUISERGLOBEBLAZERBLUE.jpg" }, { url: "CRUISERGLOBEBLAZERBLUE_2.jpg" }],
      categoryId: 2,
    },
    {
      name: "CRUISER GLOBE SURF GLASS",
      description:
        "Ride the waves of the concrete jungle with the Cruiser Globe Surf Glass. This cruiser board combines the smoothness of surfing with the agility of skateboarding. With its sleek design and durable construction, this board is built to handle any urban adventure. Whether you're carving up the streets or cruising along the beach promenade, the Cruiser Globe Surf Glass will take your riding experience to the next level.",
      slug: "CRUISER-GLOBE-SURF-GLASS",
      highlight: false,
      stock: 15,
      price: 299.99,
...
This softboard features a length of 7.0 feet, providing ample buoyancy and ease of paddling. The soft construction and rounded rails enhance safety, making it ideal for learners who are developing their skills and looking for a forgiving board.`,
    ...
    },
    {
      ...
      price: 354.99,
      photos: [
        { url: "TABLASSURFSOFTECHSURFBOARDMASONTWIN510.jpg" },
        { url: "TABLASSURFSOFTECHSURFBOARDMASONTWIN510_2.jpg" },
      ],
      categoryId: 4,
    },
    {
      ...
      price: 354.99,
      photos: [
        { url: "TABLASSURFSOFTECHSURFBOARDROLLER66.jpg" },
        { url: "TABLASSURFSOFTECHSURFBOARDROLLER66_2.jpg" },
      ],
      categoryId: 4,
    },
    {
      ...
      price: 314.99,
      photos: [
        { url: "TABLASSURFSOFTECHSURFBOARDHANDSHAPEDSALLYFITZGIBBONS60.jpg" },
        { url: "TABLASSURFSOFTECHSURFBOARDHANDSHAPEDSALLYFITZGIBBONS60_2.jpg" },
      ],
      categoryId: 4,
    },
    {
      ...
      price: 314.99,
      photos: [
        { url: "TABLASSURFQUIKSILVERSOFTBOARDDISCUS66.jpg" },
        { url: "TABLASSURFQUIKSILVERSOFTBOARDDISCUS66_2.jpg" },
        { url: "TABLASSURFQUIKSILVERSOFTBOARDDISCUS66_3.jpg" },
      ],
      categoryId: 4,
    },
  ];
